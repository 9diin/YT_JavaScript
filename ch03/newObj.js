// 3. 프로퍼티 열거
// 객체의 프로퍼티 전체를 순회해야 할 때도 있습니다.

let newObj = { x: 1, y: 2, z: 3 }; // 열거 가능한 자체 프로퍼티 세 개
...
// 4. 객체 확장
// 자바스크립트 프로그램에서 객체의 프로퍼티를 다른 객체에 복사하는 것은 흔한 일입니다. 얕은 복사, 깊은 복사라는 말 많이 들어보셨죠?
...
// 두 번째 소스 객체가 있다면 그 객체의 프로퍼티가 첫 번째 소스 객체이 있는 같은 이름의 프로퍼티를 덮어 씁니다.
...
// 위처럼 객체를 복사하고 덮어쓰는 동작을 다음과 같인 스프레드 연산자(분해 연산자) ...으로 하는 방법도 있습니다.
