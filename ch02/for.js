...
// for-of에서도 마찬가지로 괄호 안에는 변수 선언(이미 선언된 변수의 경우에는 그 이름)이 있고, of 키워드가 있고, 그 뒤에는 data 처럼 이러터블 객체로 평가되는 표현식이 있습니다.
...
// for-of와 참조 타입의 객체
// 참조 타입의 객체(이하 객체)는 기본적으로 이터러블이 아닙니다.
